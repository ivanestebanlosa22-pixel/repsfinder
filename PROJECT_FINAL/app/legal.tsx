...
const styles = StyleSheet.create({
  ...
  header: { position: 'absolute', top: 0, left: 0, right: 0, backgroundColor: '#000', paddingHorizontal: 20, paddingBottom: 15, zIndex: 10, borderBottomWidth: 1, borderBottomColor: '#111', flexDirection: 'row', alignItems: 'center', gap: 12 },
  backButton: { width: 40, height: 40, justifyContent: 'center', alignItems: 'center' },
  backIcon: { fontSize: 28, color: '#00e5b0', fontWeight: '700' },
